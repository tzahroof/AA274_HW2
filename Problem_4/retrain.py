# Taken from https://github.com/tensorflow/tensorflow/blob/ba032db13627945e7cc772dbd3d85d257aef3ab9/tensorflow/examples/image_retraining/retrain.py
# Slightly modified to change bottleneck input tensor name scope (line 768), expose logits for saliency computation (line 814), and to name ops in JPEG decoded (line 982); some flag defaults changed as well
...
def add_final_training_ops(class_count, final_tensor_name, bottleneck_tensor,
  ...
  """
  with tf.name_scope('bottleneck_input'):
...
def add_jpeg_decoding(input_width, input_height, input_depth, input_mean,
  ...
  decoded_image = tf.image.decode_jpeg(jpeg_data, channels=input_depth, name='JPG_uint8')
  decoded_image_as_float = tf.cast(decoded_image, dtype=tf.float32, name='JPG_float32')
  decoded_image_4d = tf.expand_dims(decoded_image_as_float, 0)
  ...
  mul_image = tf.multiply(offset_image, 1.0 / input_std, name='NormalizedImage')
